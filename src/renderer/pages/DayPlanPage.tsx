  ...
  return (
    <div className="min-h-full flex flex-col p-8 max-w-xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-400 text-sm mt-1">What do you want to accomplish today?</p>
      </div>
      ...
      <div className="mb-8">
        <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest block mb-2">
          One word or phrase to keep in mind today <span className="text-slate-600 normal-case font-normal">(optional)</span>
        </label>
        <input
          className="input"
      ...
      >
        {saved ? (
          ...
          <>Start your day <ChevronRight size={18} /></>
        )}
      </button>
